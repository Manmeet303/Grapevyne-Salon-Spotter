<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3_2profile.aspx.cs" Inherits="_3_2profile" %>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/css/all.min.css"
    ...
    crossorigin="anonymous" referrerpolicy="no-referrer" />
      <link rel="stylesheet" href="css/3_2profile.css"/>
...
<body>
    ...
    <div class="profile-card">
      <div class="profile-header" style="background-image: url(./Images/3.jpg); background-position: 20px -70px;">
        <!-- profile header section -->

        <div class="main-profile">
          <div class="profile-image" style="background-image: url(./Images/7.jpg); background-position: 160px;"></div>
          <div class="profile-names">
            <h1 class="username"><asp:Label ID="lblSalonName" runat="server" Text=""></asp:Label></h1>
      ...
      <div class="profile-body"><!-- profile body section -->
        <div class="profile-actions">
          ...
          <section class="bio">
            ...
            <hr>
            <p class="bio-text">
              Micky is an experienced natural hair proffesional with more than 10 year of salon experience
          ...
          <div class="service">
            <div class="booking">
              <table class="booking  position-absolute">
                ...
                <asp:Repeater ID="rptHairstyles" runat="server">
    <ItemTemplate>
        <tr>
            <td>
                <h5><%# Eval("HairStyleName") %><br>$<%# Eval("Prize") %></h5>
            </td>
            <td>
                <button type="button" style="background-color: rgb(137, 131, 131); color: aliceblue;
      ...
      <form id="form1" runat="server">
        <table class="form-group">
          ...
          <tr>
            ...
            <td>:</td>
            <td>
                <asp:TextBox ID="txtCustomerName" placeholder="Enter Customer Name" runat="server" CssClass="form-control"></asp:TextBox>
...
ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
          ...
          <tr>
            ...
            <td>:</td>
            <td>
                <asp:Calendar ID="dycalendar" runat="server" OnDayRender="dycalendar_DayRender" CssClass="form-control" style="font-size: 15px; background-color: floralwhite; border-radius: 8px;" placeholder="Select appointment date"> </asp:Calendar>
