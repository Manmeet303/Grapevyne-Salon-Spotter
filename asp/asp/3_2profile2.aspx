<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3_2profile2.aspx.cs" Inherits="_3_2profile2" %>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="css/3_2profile2.css"/>
</head>
<body>
    <div class="container">

    <div class="profile-card">
      <div class="profile-header" style="background-image: url(./Images/c-1.jpg); background-position: 20px -100px;">
        <!-- profile header section -->

        <div class="main-profile">
          <div class="profile-image"
            style="background-image: url(./Images/OIP\ \(1\).jfif); background-position: 130px -5px; "></div>
          <div class="profile-names">
            <h1 class="username">J.K Rowling</h1>
      ...
      <div class="profile-body"><!-- profile body section -->
        <div class="profile-actions">
          ...
          <section class="bio">
            ...
            <hr>
            <p class="bio-text">
              J.K Rowling is an experienced natural hair proffesional with more than 10 year of salon experience
