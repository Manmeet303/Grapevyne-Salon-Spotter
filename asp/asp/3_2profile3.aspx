<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3_2profile3.aspx.cs" Inherits="_3_2profile3" %>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="css/3_2profile3.css"/>
</head>
<body>
    <div class="container">

    <div class="profile-card">
      <div class="profile-header" style="background-image: url(./Images/h3.png); background-position: 20px -70px;">
        <!-- profile header section -->

        <div class="main-profile">
          <div class="profile-image"
            style="background-image: url(./Images/style10.png); background-position: 133px 1px;"></div>
          <div class="profile-names">
            <h1 class="username">Oliva Adward</h1>
      ...
      <div class="profile-body"><!-- profile body section -->
        <div class="profile-actions">
          ...
          <section class="bio">
            ...
            <hr>
            <p class="bio-text">
              Oliva is an experienced natural hair proffesional with more than 10 year of salon experience
